...
public class GUI extends Application {
    ...
    private Button firstAttackButton, secondAttackButton, thirdAttackButton, fourthAttackButton;
    @Override
    public void start(Stage battleStage) {
        ...
        Rectangle battleBorder = new Rectangle(125, 20, 655, 220);
        ...
        //GraphicsContext testText = battleCanvas.getGraphicsContext2D();
        //testText.setFill(Paint.valueOf("Red"));
        //testText.setStroke(Paint.valueOf("Black"));
        //testText.setLineWidth(1);
        //javafx.scene.text.Font battleFont = javafx.scene.text.Font.font("Times New Roman", BOLD, 40);
        //testText.setFont(battleFont);
        //testText.fillText("TESTING", 180, 180);
        //testText.strokeText("TESTING", 180, 180);
        //testText.setFill(Paint.valueOf("Transparent"));

        battlePane.getChildren().addAll(battleBorder, attackOutline, screenBorder, textOutput, userStats, enemyStats, userVersusEnemy);
        battlePane.getChildren().addAll(firstAttackButton, secondAttackButton, thirdAttackButton, fourthAttackButton);
        ...
        // END OF BATTLE PANE CODE, NOW ON TO THE MENU PANE CODE


        Rectangle MenuScreenBorder = new Rectangle(5, 5, 790, 390);
        MenuScreenBorder.setStroke(Paint.valueOf("Black"));
        MenuScreenBorder.setFill(null);
        MenuScreenBorder.setStrokeWidth(5);

        Rectangle innerScreenBorder = new Rectangle(12, 12, 776, 376);
        ...
        javafx.scene.text.Font backFont = javafx.scene.text.Font.font("Times New Roman", BOLD, 56 );
        ...
        GraphicsContext copyright = canvas.getGraphicsContext2D();
        copyright.setFill(Paint.valueOf("Transparent"));
        copyright.setStroke(Paint.valueOf("Black"));
        copyright.setLineWidth(1);
        javafx.scene.text.Font copyrightFont = javafx.scene.text.Font.font("Times New Roman", 8);
        ...
        javafx.scene.text.Font startFont = javafx.scene.text.Font.font("Times New Roman", BOLD, 25);
        ...
        menuPane.getChildren().addAll(canvas, startButton, MenuScreenBorder, innerScreenBorder);
        battlePane.getChildren().addAll();
        //make 2 scenes from 2 panes

        Scene menuScene = new Scene(menuPane, 800, 400);
    ...
    private void attackButtonClicked(ActionEvent event) {
        if (event.getSource()==firstAttackButton)
            System.out.println("It worked!");
        if (event.getSource()==secondAttackButton)
            System.out.println("It worked!");
        if (event.getSource()==thirdAttackButton)
            System.out.println("It worked!");
        if (event.getSource()==fourthAttackButton)
            System.out.println("It worked!");
